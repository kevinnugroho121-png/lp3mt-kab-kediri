                            ...
                            <tr class="hover:bg-yellow-50 transition duration-150">
                                ...
                                <td class="border border-gray-300 px-2 py-1 text-center">
                                    <div class="flex justify-center items-center gap-1">
                                        ...
                                        {{-- Hapus --}}
                                        <form id="form-delete-desa-{{ $desa->id }}" action="{{ route('desa.destroy', $desa->id) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" onclick="triggerStatusUpdate('Yakin hapus desa ini?', 'form-delete-desa-{{ $desa->id }}')" class="p-1 rounded hover:bg-red-100 text-red-500 transition" title="Hapus">
