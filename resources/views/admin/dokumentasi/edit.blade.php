                ...
                <form action="{{ route('dokumentasi.update', $dok->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="flex flex-col justify-center">
                            ...
                            {{-- Judul --}}
                            <div class="mb-5">
                                <label class="block text-xs font-bold text-gray-600 uppercase mb-2">Judul / Keterangan Baru</label>
                            ...
                            {{-- Foto Baru --}}
                            <div class="mb-8">
                                <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Ganti Foto Baru <span class="text-gray-400 lowercase font-normal">(Opsional)</span></label>
                                <input type="file" name="foto" accept="image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition mt-2 cursor-pointer">
                            </div>

                            {{-- Tombol Aksi --}}
                            <div class="flex gap-3 mt-auto">
                                <a href="{{ route('dokumentasi.index') }}" class="w-1/3 text-center bg-gray-200 text-gray-700 py-2.5 rounded-lg text-sm font-bold hover:bg-gray-300 transition shadow-sm">Kembali</a>
