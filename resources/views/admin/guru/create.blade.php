    ...
    <div class="py-10">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Tambah Guru {{ $type }}</h1>
                    <p class="text-sm text-gray-500 mt-1">Lengkapi data identitas.</p>
                </div>
                @php
                ...
                <form action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data" class="p-8" id="guruForm">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 mb-1 text-center">Nama Lengkap (Sesuai KTP) <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1 text-center">NIK (16 Digit) <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1 text-center">Jenis Kelamin <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1 text-center">Status Kepegawaian <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1 text-center">Status Sertifikasi / Inpassing <span class="text-red-500">*</span></label>
                            ...
                            <div class="md:col-span-2 bg-yellow-50 p-4 rounded-lg border border-yellow-200 transition-colors" id="box_insentif">
                                <label class="block text-sm font-bold text-gray-800 mb-1 text-center">Apakah Menerima Insentif? <span class="text-red-500">*</span></label>
                                ...
                                <p class="text-[10px] text-gray-500 text-center mt-1" id="msg_insentif">*Pilih "YA" jika guru ini berhak menerima insentif.</p>
                            </div>
                    ...
                    <div class="mb-10">
                        <div class="flex items-center gap-2 mb-4 pb-2 border-b border-gray-100">
                            ...
                            <h3 class="text-lg font-bold text-gray-800">Kelembagaan & Wilayah</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" value="{{ $type }}" class="w-full bg-gray-100 border-gray-300 rounded-lg shadow-sm text-sm py-2.5 text-center font-bold text-gray-500 cursor-not-allowed" readonly>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-bold text-gray-800 mb-1 text-center text-green-700">Lembaga Tempat Mengajar <span class="text-red-500">*</span></label>
                                
                                {{-- Select Box Baru --}}
                                <select name="lembaga_id" id="lembagaSelect" class="w-full border-green-500 border-2 rounded-lg shadow-sm text-sm py-2.5 text-center font-bold text-gray-800 bg-green-50 focus:ring-green-500" required>
                                    <option value="" disabled selected>-- Pilih Desa Terlebih Dahulu --</option>
                                </select>
                                <p class="text-[10px] text-gray-500 mt-1 text-center">*Daftar lembaga akan muncul setelah Anda memilih Desa.</p>
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 mb-1 text-center">Nomor Rekening BANK JATIM</label>
                        ...
                        <div class="space-y-8">
                            <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                                ...
                                <div class="relative group text-center">
                                    <input type="file" name="file_ktp" id="file_ktp" accept="application/pdf" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-6 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-blue-600 file:text-white hover:file:bg-blue-700 transition cursor-pointer text-center" onchange="handleFileSelect(this, 'preview_ktp', 'btn_reset_ktp')">
                            ...
                            <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                                <label class="block text-base font-bold text-gray-800 mb-3 text-center">2. Scan Kartu Keluarga</label>
                                <div class="relative group text-center">
                                    <input type="file" name="file_kk" id="file_kk" accept="application/pdf" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-6 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-green-600 file:text-white hover:file:bg-green-700 transition cursor-pointer text-center" onchange="handleFileSelect(this, 'preview_kk', 'btn_reset_kk')">
                            ...
                            <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                                <label class="block text-base font-bold text-gray-800 mb-3 text-center">3. Scan Buku Rekening</label>
                                <div class="relative group text-center">
                                    <input type="file" name="file_bukurekening" id="file_bukurekening" accept="application/pdf" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-6 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-purple-600 file:text-white hover:file:bg-purple-700 transition cursor-pointer text-center" onchange="handleFileSelect(this, 'preview_rekening', 'btn_reset_rekening')">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
                        <a href="{{ $backRoute }}" class="px-5 py-2.5 text-sm font-bold text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition">Batal</a>
