                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" required class="w-full border border-gray-600 rounded-md px-2 py-1 h-[32px] text-xs font-bold text-black-800 focus:border-blue-500 focus:ring-blue-500 shadow-sm uppercase" oninput="this.value = this.value.toUpperCase()">
                            </div>
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required placeholder="dd-mm-yyyy" class="w-full border border-gray-600 rounded-md px-2 py-1 h-[32px] text-xs font-bold text-black-800 focus:border-blue-500 focus:ring-blue-500 shadow-sm bg-white">
                            </div>
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="nama_ibu_kandung" value="{{ old('nama_ibu_kandung') }}" required class="w-full border border-gray-600 rounded-md px-2 py-1 h-[32px] text-xs font-bold text-black-800 focus:border-blue-500 focus:ring-blue-500 shadow-sm uppercase" oninput="this.value = this.value.toUpperCase()">
                            </div>
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="no_hp" value="{{ old('no_hp') }}" required placeholder="08xxxxxxxxxx" class="w-full border border-gray-600 rounded-md px-2 py-1 h-[32px] text-xs font-bold text-black-800 focus:border-blue-500 focus:ring-blue-500 shadow-sm">
                            </div>
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="nomor_rekening" value="{{ old('nomor_rekening') }}" required placeholder="Nomor Rekening" class="w-full border border-gray-600 rounded-md px-2 py-1 h-[32px] text-xs font-bold text-black-800 focus:border-blue-500 focus:ring-blue-500 shadow-sm">
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            flatpickr("#tanggal_lahir", {
                dateFormat: "Y-m-d",     // Format yang dikirim ke database MySQL
                altInput: true,
