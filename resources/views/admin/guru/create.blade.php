                ...
                <form action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data" class="p-8" id="guruForm">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <div class="md:col-span-1">
                                <label class="block text-[10px] font-bold text-gray-600 uppercase tracking-wider mb-1">Sertifikasi / Inpassing <span class="text-red-500">*</span></label>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" value="{{ $type }}" class="w-full bg-gray-100 border border-gray-600 rounded-md px-2 py-1 h-[32px] text-xs font-bold text-gray-500 cursor-not-allowed shadow-sm" readonly>
                            </div>
