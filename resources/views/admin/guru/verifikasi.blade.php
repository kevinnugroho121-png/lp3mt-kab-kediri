<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-gray-800 leading-tight">Verifikasi Guru</h2>
    </x-slot>
    ...
    <div class="py-10">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                @endphp
                <a href="{{ $backRoute }}" class="px-4 py-2 bg-white border border-gray-300 rounded-md text-xs font-bold text-gray-700 shadow-sm hover:bg-gray-50 transition">
                    &larr; Kembali
                </a>
            </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-blue-200 overflow-hidden">
                        ...
                        <div class="p-6 bg-gray-50 text-center">
                            ...
                            @else
                                <div class="h-40 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg text-gray-400 italic bg-white">
                ...
                <div class="mt-8 bg-white p-6 rounded-xl shadow-lg border border-gray-200 sticky bottom-4 z-50">
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <div class="flex-grow w-full">
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Catatan Verifikasi (Opsional)</label>
                        ...
                        <div class="flex gap-3 w-full md:w-auto">
                            <a href="{{ $backRoute }}" class="flex-1 md:flex-none px-6 py-3 bg-gray-100 text-gray-700 font-bold rounded-lg hover:bg-gray-200 transition text-center border border-gray-300">
                                Batal
                            </a>
