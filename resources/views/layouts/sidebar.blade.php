<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0 border-r border-gray-200 shadow-sm">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="space-y-2">
            ...
            {{-- ================================================= --}}
            {{-- REVISI: PECAH MENU GURU JADI 5 TOMBOL --}}
            {{-- ================================================= --}}

            {{-- 4a. DATA GURU MADIN --}}
            <li class="relative px-2">
                <a href="#" class="inline-flex items-center w-full px-4 py-3 text-sm font-semibold text-gray-600 transition-colors duration-150 rounded-lg hover:bg-green-50 hover:text-green-700">
                    {{-- Icon Kitab --}}
            ...
            {{-- 4d. SEMUA GURU --}}
            <li class="relative px-2">
                {{-- Sementara saya arahkan ke guru.index agar data lama tetap bisa diakses --}}
                <a href="{{ route('guru.index') }}" class="inline-flex items-center w-full px-4 py-3 text-sm font-semibold text-gray-600 transition-colors duration-150 rounded-lg hover:bg-green-50 hover:text-green-700">
                    {{-- Icon Group --}}
            ...
            <li class="relative px-2 mt-2">
                <a href="#" class="inline-flex items-center w-full px-4 py-3 text-sm font-bold text-green-700 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 transition-colors duration-150 shadow-sm">
                    {{-- Icon Uang/Dolar --}}
